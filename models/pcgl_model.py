...
from models.gather_layer import GatherLayer


class PCGLModel(BaseModel):
    """
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.add_argument('--lbd', default=0.01, type=float, help='Relative strength of the fake loss of sup and simclr')
    ...
    def __init__(self, opt):
        ...
        self.loss_names = ['G_s', 'per', 'D_real', 'D_fake', 'G_GAN']
    ...
    def backward_G(self):
        ...
        self.loss_G = self.loss_G_GAN + self.loss_per + self.loss_G_s
